...
User Function UsrCtrLib()
	...
	If nEscolha == 1
		If !ExisteSX6("MV_LIBCOM")
			CriarSX6("MV_LIBCOM","C","Guarda os usuarios que possuem autoriza็a๕ de liberacao comercial","000000")
		EndIf
	...
	ElseIf nEscolha == 2
		...
		If !ExisteSX6("MV_LIBMAR")
			CriarSX6("MV_LIBMAR","C","Guarda os usuarios que possuem autoriza็a๕ de liberacao Margem","000000")
		EndIf
	...
	ElseIf nEscolha == 3
		...
		If !ExisteSX6("MV_LIBFIN")
			CriarSX6("MV_LIBFIN","C","Guarda os usuarios que possuem autoriza็a๕ de liberacao Financeira","000000")
		EndIf
	...
	ElseIf nEscolha == 4
		...
		If !ExisteSX6("MV_IMPROM")
			CriarSX6("MV_IMPROM","C","Guarda os usuarios que possuem autoriza็a๕ de liberacao Financeira","000000")
		EndIf
